## Contributing to MBED_RP2040_Slow_PWM
...
```
xy@xy-Inspiron-3593:~$ cd Arduino/xy/MBED_RP2040_Slow_PWM_GitHub/
xy@xy-Inspiron-3593:~/Arduino/xy/MBED_RP2040_Slow_PWM_GitHub$
```

2. Issue astyle command

```
xy@xy-Inspiron-3593:~/Arduino/xy/MBED_RP2040_Slow_PWM_GitHub$ bash utils/restyle.sh
```
