...
class MBED_RP2040_Slow_PWM_ISR 
{
...
#define MAX_NUMBER_CHANNELS        16
    ...
    int setPWM(const uint32_t& pin, const float& frequency, const float& dutycycle, 
  ...
  private:
    ...
    int setupPWMChannel(const uint32_t& pin, const uint32_t& period, const float& dutycycle, 
